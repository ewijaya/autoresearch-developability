...
A set of 3{,}554 peptides scored across activity, toxicity, stability, and developability, evaluated under three mathematically distinct oracle definitions, is released so other groups can benchmark their own triage methods on a common target.
