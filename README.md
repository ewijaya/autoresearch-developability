...
- **Wijaya, E.** *Agent-Guided Ranking Policy Improvement for Peptide Drug Candidate Prioritization.* bioRxiv (preprint, DOI pending). The compiled PDF is in `manuscript/main.pdf`.
